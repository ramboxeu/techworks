...
public class DataConstants {
    ...
    public static class Items {
        ...
        public static final ItemRegistryObject<?>[] ITEM_GENERATED = new ItemRegistryObject[] {
                ...
                LARGE_GAS_TANK, HICAP_GAS_TANK, ELECTRIC_DRILL, COPPER_WIRE, COPPER_PLATE, IRON_DOUBLE_PLATE, COAL_DUST
        };

        public static final ItemRegistryObject<?>[] HANDHELD = new ItemRegistryObject[] {
                STEEL_PICKAXE, STEEL_AXE, STEEL_SHOVEL, STEEL_HOE, STEEL_SWORD, HAMMER, WIRE_CUTTERS
        };
    }
