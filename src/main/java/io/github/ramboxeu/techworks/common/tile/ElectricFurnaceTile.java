...
public class ElectricFurnaceTile extends AbstractMachineTile {
    public ElectricFurnaceTile() {
        super(Registration.ELECTRIC_FURNACE_TILE.get(), 150);
    }
    ...
    boolean canWork() {
        ...
        return this.world.getRecipeManager().getRecipe(IRecipeType.SMELTING, inventory, this.world).isPresent() &&
