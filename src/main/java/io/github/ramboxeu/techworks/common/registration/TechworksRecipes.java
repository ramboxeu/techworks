...
public class TechworksRecipes {
    ...
    public static final RecipeRegistryObject<WireCuttingRecipe, WireCuttingRecipe.Serializer> WIRE_CUTTING = RECIPES.register("wire_cutting", WireCuttingRecipe.Serializer::new);
}
